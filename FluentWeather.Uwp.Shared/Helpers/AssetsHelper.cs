...
public static class AssetsHelper
{
    extension(WeatherCode weatherType)
    {
        public string GetWeatherIconName()
        {
            return weatherType switch
            {
                ...
                LightDrizzle or ModerateDrizzle or DenseDrizzle => "LightRain.png",
                ModerateRainShowers => "LightRain.png",
                PartlyCloudy => "Cloudy.png",
                Overcast => "VeryCloudy.png",
                SlightSnowFall => "LightSnow.png",
                ModerateSnowFall or SnowGrains => "LightSnow.png",
                HeavySnowFall => "HeavySnow.png",
                Mist or DepositingRimeFog => "Fog.png",
                Fog => "Fog.png",
                LightFreezingDrizzle or DenseFreezingDrizzle or LightFreezingRain or HeavyFreezingRain => "FreezingRain.png",
    ...
    extension(Uri sourceUri)
    {
        public async Task<Uri> ToBase64Url()
        {
